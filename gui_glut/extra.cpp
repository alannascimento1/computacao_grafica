...
Camera* glutGUI::cam = new CameraDistante(-20,25,0, 0,0,0, 0,1,0);
...
void glutGUI::defaultKey(unsigned char key, int x, int y)
{
    ...
    case 'c':
        posCam = 1;
        delete cam;
        cam = new CameraDistante(-20,25,0, 0,0,0, 0,1,0);//CameraDistante(0,1,5, 0,1,0, 0,1,0);
        break;
    case 'j':
        posCam = 1;
        delete cam;
...
//            cam = new CameraDistante(); //CameraDistante(0,1,5, 0,1,0, 0,1,0);
            cam = new CameraDistante(-5.1,2,4,    -3,2,4,    0,1,0);
            break;
        case 2:
//            cam = new CameraDistante(5,1,0, 0,1,0, 0,1,0);
            cam = new CameraDistante(-8.7,2,-10,    -7.7,2,-3,     0,1,0);
            break;
        case 3:
//            cam = new CameraDistante(0,1,-5, 0,1,0, 0,1,0);
            cam = new CameraDistante(4.5, 0.5, -3.5,    6.5, 0.5, -3.5,     0,1,0);
            break;
        case 4:
//            cam = new CameraDistante(-5,1,0, 0,1,0, 0,1,0);
              cam = new CameraDistante(7,8,6, 6,0,-7, 0,1,0);
            break;
        case 5:
//            cam = new CameraDistante(0,6,0, 0,1,0, 0,0,-1);
            cam = new CameraDistante(1.5,16,20, 1.5,0,7, 0,1,0);
            break;
        }
        break;
    case 's':
